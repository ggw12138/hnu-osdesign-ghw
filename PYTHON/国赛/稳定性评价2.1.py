...
data = pd.read_excel('D:\日常应用\学习资料（课堂PPT等等）\数学建模\国赛题目\CUMCM2020Probelms\C\稳定性评价数据2.xlsx')
...
with open('D:\日常应用\学习资料（课堂PPT等等）\数学建模\国赛题目\CUMCM2020Probelms\C\前五总占比.txt', 'w') as f:
    for k1 in dictionary1:
        f.write(str(k1))
        f.write(",")
        curr_dict = dictionary1[k1]
